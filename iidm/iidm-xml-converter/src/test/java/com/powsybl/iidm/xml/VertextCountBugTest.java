 ...
 */
public class VertextCountBugTest {
    ...
    public void test() {
        ...
        // The PowsyblException (Vertex 1 not found) should not be thrown anymore
        vl.newGenerator()
                .setId("G")
                .setNode(1)
                .setMinP(0.0)
        ...
        // Remove the generator and clone the network*
        network.getGenerator("G").remove();
    ...
    @Test
    public void createMissingVertex() {
        Network network = createNetwork();
        VoltageLevel vl = network.getVoltageLevel("VL");
        VoltageLevel.NodeBreakerView view = vl.getNodeBreakerView();
        ...
        // Create a switch between node 0 and 5, whereas the node count is equal to 3
        // The PowsyblException (Vertex 5 not found) should not be thrown anymore
        view.newBreaker()
                .setId("switch")
                .setNode1(0)
                .setNode2(5)
